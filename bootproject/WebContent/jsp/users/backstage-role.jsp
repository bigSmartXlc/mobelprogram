                ...
                <form class="layui-form" lay-filter="formTestFilter"
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="roleName" id="roleName" required lay-verify="required"
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="roleDesc" id="roleDesc" required lay-verify="required"
...
<script type="text/html" id="barDemo">
    <a class="layui-btn layui-btn-xs layui-btn-normal" lay-event="savePermission">保存权限</a>
...
<script>
    ...
    $(function () {
        layui.use(['table', 'form'], function () {
            ...
            table.render({
                elem: '#newslist',
                height: 312,
                url: '../backstageRoles/findAllBackstageRole.action' //数据接口
                ,
                page: true //开启分页
                ,
                cols: [[ //表头
            ...
            table.on('tool(test)', function (obj) {
                ...
                } else if (obj.event === 'savePermission') {
            ...
            form.on('submit(formAdd)', function (data) {
                ...
                //alert(formData);
                $.ajax({
                    url: '../backstageRoles/addBackstageRole.action',
                    data: data.field,
                    type: 'POST',
                    dataType: 'json',
    ...
    function delNews(id) {
        $.ajax({
            type: 'POST',
            url: '../backstageRoles/deleteBackstageRole.action',
            data: {'id': id},
            dataType: 'json',
            success: function () {
