...
<script type="text/html" id="barDemo">
    <a class="layui-btn layui-btn-xs layui-btn-normal" lay-event="addRole">添加角色</a>
...
<script>
    ...
    $(function () {
        ...
        layui.use(['table', 'form'], function () {
            ...
            table.render({
                elem: '#newslist',
                height: 312,
                url: '../backstageUsers/findAllBackstageUser.action' //数据接口
                ,
                page: true //开启分页
                ,
                cols: [[ //表头
            ...
            table.on('tool(test)', function (obj) {
                ...
                if (obj.event === 'del') {
                    ...
                    layer.open({
                        ...
                        title: "添加角色",
                        area: ['80%', '80%'],
                        content: './role-add.html?userId=' + data.id,
                    ...
                    layer.open({
                        ...
                        title: "用户详情",
                        area: ['80%', '80%'],
                        content: './user_details.html?userId=' + data.id
            ...
            form.on('submit(formAdd)', function (data) {
                ...
                //alert(formData);
                $.ajax({
                    url: '../backstageUsers/addBackstageUser.action',
                    data: data.field,
                    type: 'POST',
                    dataType: 'json',
                    success: function (data) {
                        if (data.code == 200) {
                            layer.msg("保存用户成功", function () {
                                // 获得frame索引
    ...
    function delNews(id) {
        $.ajax({
            type: 'POST',
            url: '../backstageUsers/deleteBackstageUser.action',
            data: {'id': id},
            dataType: 'json',
            success: function () {
