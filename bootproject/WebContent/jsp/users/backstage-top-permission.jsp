                ...
                <form class="layui-form" lay-filter="formTestFilter"
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="menuName" id="menuName" required lay-verify="required"
...
<script>
    ...
    $(function () {
        layui.use(['table', 'form'], function () {
            ...
            table.render({
                elem: '#newslist',
                height: 312,
                url: '../backstageTopPermissions/findAllBackstageTopPermission.action' //数据接口
                ,
                page: true //开启分页
                ,
                cols: [[ //表头
            ...
            form.on('submit(formAdd)', function (data) {
                ...
                //alert(formData);
                $.ajax({
                    url: '../backstageTopPermissions/addBackstageTopPermission.action',
                    data: data.field,
                    type: 'POST',
                    dataType: 'json',
            ...
            form.on('submit(formUpdate)', function (data) {
                ...
                $.ajax({
                    url: '../backstageTopPermissions/updateBackstageTopPermission.action',
                    data: data.field,
                    type: 'POST',
                    dataType: 'json',
                    success: function (data) {
    ...
    function delNews(id) {
        $.ajax({
            type: 'POST',
            url: '../backstageTopPermissions/deleteBackstageTopPermission.action',
            data: {'id': id},
            dataType: 'json',
