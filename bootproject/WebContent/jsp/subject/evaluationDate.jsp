...
<body>
                            ...
                            function() {
                                ...
                                table
                                        .render({
                                            elem : '#newslist',
                                            height : 312,
                                            url : '../evaluationDates/findAllEvaluationDate.action' //数据接口
                                            ,
                                            page : true //开启分页
                                            ,
                                            cols : [ [ //表头
                                                    ...
                                                    },
                                                    {
                                                        title : '级别',
                                                        width : 120,
                                                        templet : '<div>{{createrFormat(d.level.level)}}</div>'
                                                    },
                                                    {
                                                        title : '类别',
                                                        width : 120,
                                                    ...
                                                    },
                                                    {
                                                        title : '科目',
                                                        width : 120,
                                                        templet : '<div>{{createrFormat(d.subject.name)}}</div>'
                                                    },
                                                    {

                                                        title : '测评日期',
                                                        width : 120,
                                                        templet : '<div>{{Format(d.testDate,"yyyy-MM-dd")}}</div>'
                                                    }
                                                    ,
                                                    {
    ...
    function addnews() {
        ...
        function delNews(id) {
            $.ajax({
                type : 'POST',
                url : '../evaluationDates/deleteEvaluationDate.action',
                data : {
                    'id' : id
                },
                dataType : 'json',
