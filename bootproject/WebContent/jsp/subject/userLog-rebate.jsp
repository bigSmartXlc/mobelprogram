       ...
       // alert();
        layui.use('table', function () {
            ...
            table.render({
                elem: '#test',
                height: 312,
                url: '/jsp/userLogs/queryUserrebate.action' + userId //数据接口
                ,
                page: true //开启分页
                ,
                cols: [[
                    ...
                    ,{field:'cost', width:140, title: '报考费用'}
                    ,{field:'returnRatio', width:80, title: '返利率'}
                    ,{field:'recommenderLevel', width:140, title: '推荐等级'}
                    ,{field:'distributionLevel', width:140, title: '分销等级'}
